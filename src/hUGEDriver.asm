...
_hUGE_dosound::
    ; Only update playback if music is enabled
    ld a, [wEnabledMisc]
...
; Exported so it can be reused by audio driver in audio.asm
; Note: The hUGEDriver and Libbet audio systems use slightly different
;  note/pitch tables! The hUGE table is 72 entries, while the Libbet
;  one is 64 entries and offset slightly.
note_table::
